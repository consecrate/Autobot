...
<div class="example">
  <div class="stepHeader">
    <span class="stepType">Example:</span> Solving...
  </div>
...
Target: `questionWidget-text` + `questionWidget-body` (Front) → `questionWidget-explanation` (Back).

```html
<div class="step questionWidget">
  <div class="questionWidget-title">Question 1</div>
  <div class="questionWidget-body">
    <div class="questionWidget-text"><p>Find the solution...</p></div>
  </div>
  <div class="questionWidget-result">Correct</div>
  <!-- Only visible after submit -->
  <div class="questionWidget-explanation">...</div>
  <!-- Useful after submit -->
</div>
```
...
| **Front**     | `.exampleQuestion`      | `.questionWidget-text` + `.questionWidget-body` |
...
- **Questions**: Capture both `.questionWidget-text` and `.questionWidget-body` for Front. Wait for `.questionWidget-explanation` to appear before allowing capture.
...
| **Question** | `.questionWidget-text` + `.questionWidget-body` | `.questionWidget-explanation` | Capture after answer  |
